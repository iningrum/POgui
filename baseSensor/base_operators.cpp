...
int main()
{
	const CTemperatureSensor<float> TemperatureSensor(-35.0, -30.0);	//Utworzenie obiektu reprezentującego czujnik temperatury
	CHumiditySensor<float> HumiditySensor(95.0, 100.0);				//Utworzenie obiektu reprezentującego czujnik wilgotności
	CPressureSensor<float> PressureSensor(950, 1050);				//Utworzenie obiektu reprezentującego czujnik ciśnienia atmosferycznego
	CWindSensor<float> WindSensor(0, 10000);							//Utworzenie obiektu reprezentującego czujnik prędkości wiatru
	CInsolationSensor<float> InsolationSensor(0, 1000);				//Utworzenie obiektu reprezentującego czujnik nasłonecznienia
	...
	CBase<float> Base(3);	//Utworzenie pierwszego obiektu reprezentującego stację bazową
